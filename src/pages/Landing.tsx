  ...
  return (
    <div className="flex flex-col bg-white text-gray-900 min-h-screen">
        ...
        <nav className="static sm:absolute top-0 left-0 right-0 z-20 px-4 sm:px-6 py-3 sm:py-5">
          <div className="max-w-[88rem] mx-auto flex items-center justify-between gap-3 sm:gap-0 flex-wrap sm:flex-nowrap">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-lg sm:text-2xl font-medium tracking-tight text-blue-600">Tesla</span>
            </div>

            <div className="hidden md:flex items-center gap-4 lg:gap-8 text-xs sm:text-base text-gray-600 font-medium transition-colors duration-200">
              <Link to="/dashboard/markets" className="hover:text-blue-600">Markets</Link>
              <Link to="/dashboard" className="hover:text-blue-600">Dashboard</Link>
              <Link to="/dashboard/portfolio" className="hover:text-blue-600">Portfolio</Link>
              <Link to="/dashboard/profile" className="hover:text-blue-600">Profile</Link>
              <Link to="/dashboard/wallet" className="hover:text-blue-600">Wallet</Link>
            </div>

            <Link
              to="/login"
              className="bg-blue-600 text-white text-xs sm:text-base font-medium px-4 sm:px-7 py-2 sm:py-2.5 rounded-full hover:bg-blue-700 transition-colors duration-200"
            >
              Open Wallet
            </Link>
          </div>
        ...
        <div className="flex-1 px-4 sm:px-6 pt-12 sm:pt-20 pb-6 sm:pb-6 flex items-end">
          <div className="relative w-full rounded-xl sm:rounded-2xl overflow-hidden" style={{ height: 'auto' }}>
            ...
            <div className="relative z-10 flex flex-col items-start justify-start h-full p-12 pt-36">
              <h1 className="text-blue-600 text-5xl md:text-6xl font-medium leading-tight max-w-xl mb-4" style={{ letterSpacing: '-0.04em' }}>
                Start Trading<br />Tesla Stock
              </h1>
              <p className="text-gray-600 text-base md:text-lg max-w-md mb-8 leading-relaxed" style={{ fontFamily: "'Inter', ui-sans-serif, system-ui, sans-serif" }}>
              ...
              <div className="inline-flex items-center gap-3 bg-blue-600 text-white text-base md:text-lg font-medium rounded-full hover:bg-blue-700 transition-colors duration-200">
      ...
      <section className="bg-white px-4 sm:px-6 py-12 sm:py-24">
        <div className="max-w-[88rem] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12 mb-8 sm:mb-16 items-start">
            <div>
              <h2 className="text-blue-600 text-2xl sm:text-4xl md:text-5xl font-medium leading-tight mb-6 sm:mb-8" style={{ letterSpacing: '-0.03em' }}>
                Trade with Confidence
              </h2>
              <Link
                to="/dashboard/markets"
                className="inline-flex items-center gap-2 sm:gap-3 bg-blue-600 text-white text-sm sm:text-base font-medium px-4 sm:px-6 py-2 sm:py-3 rounded-full hover:bg-blue-700 transition-colors duration-200"
              >
            ...
            <p className="text-gray-600 text-lg sm:text-2xl md:text-3xl leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="lg:col-span-2 rounded-lg sm:rounded-2xl overflow-hidden bg-blue-50" style={{ backgroundImage: 'url(https://images.higgs.ai/?default=1&output=webp&url=https%3A%2F%2Fd8j0ntlcm91z4.cloudfront.net%2Fuser_38xzZboKViGWJOttwIXH07lWA1P%2Fhf_20260423_164207_f243351d-ed59-48ec-83a0-a5e996bdbe3c.png&w=1280&q=85)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
              <div className="p-4 sm:p-7 min-h-[15rem] sm:min-h-[20rem] flex flex-col justify-between">
                <h3 className="text-blue-600 text-lg sm:text-2xl font-medium leading-snug" style={{ letterSpacing: '-0.02em' }}>
                  Live Price Feeds
                </h3>
            ...
            <div className="rounded-lg sm:rounded-2xl bg-blue-600 p-4 sm:p-7 min-h-[15rem] sm:min-h-[20rem] flex flex-col justify-between">
              <div>
                <h3 className="text-white text-lg sm:text-2xl font-medium leading-snug" style={{ letterSpacing: '-0.02em' }}>
      ...
      <section className="bg-gray-50 px-4 sm:px-6">
        <div className="max-w-[88rem] mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 items-center py-8 sm:py-12">
      ...
      <section className="bg-white px-4 sm:px-6 py-12 sm:py-24">
        <div className="max-w-[88rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-start">
          <div className="md:pr-8 md:pt-2">
            <p className="text-gray-500 text-xs sm:text-sm mb-2">Trading Features</p>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-medium leading-none mb-4 sm:mb-6 text-blue-600" style={{ letterSpacing: '-0.04em' }}>
              Advanced Tools
            </h2>
          ...
          <div className="relative rounded-lg sm:rounded-3xl overflow-hidden min-h-[300px] sm:min-h-[500px] md:min-h-[720px]">
            ...
            <div className="relative z-10 p-4 sm:p-10 md:p-12 bg-blue-900/20 backdrop-blur-sm h-full flex flex-col justify-end">
              <div className="bg-white rounded-lg sm:rounded-3xl p-4 sm:p-8 max-w-sm shadow-2xl shadow-blue-600/20">
                <h3 className="text-2xl sm:text-4xl md:text-5xl font-medium leading-tight mb-3 sm:mb-5 text-blue-600" style={{ letterSpacing: '-0.03em' }}>
                  Start Trading
                </h3>
                <p className="text-gray-700 text-sm sm:text-base max-w-md mb-6 sm:mb-8">
                ...
                <Link to="/register" className="inline-flex items-center gap-3 sm:gap-4 group">
                  <span className="text-blue-600 font-medium text-sm sm:text-base">Get Started</span>
